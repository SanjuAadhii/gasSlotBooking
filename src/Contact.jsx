                    ...
                    <div className="d-flex mb-0">
                      <div className="me-4 text-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-envelope-at" viewBox="0 0 16 16">
                          ...
                          <path d="M14.247 14.269c1.01 0 1.587-.857 1.587-2.025v-.21C15.834 10.43 15.206 10 14.28 10c-.591 0-1.03.242-1.246.616h-.034v-.515a.5.5 0 1 0-1 0v3.623a.5.5 0 0 0 1 0v-.519h.03c.215.38.658.64 1.217.64Zm.507-2.235c0 .684-.348 1.025-.587 1.025-.239 0-.587-.341-.587-1.025v-.21c0-.684.348-1.026.587-1.026.239 0 .587.342.587 1.026v.21Z" />
                        </svg>
                      </div>
                      <div>
                        <h4 className="mb-3">Email</h4>
                        <p className="mb-0">
                          <a className="link-secondary text-decoration-none" href="mailto:info@example.com">info@example.com</a>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="d-flex">
                  <div className="me-4 text-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-clock" viewBox="0 0 16 16">
                      <path d="M8 3.5a.5.5 0 0 1 .5.5v3.09l2.71 1.56a.5.5 0 0 1-.5.868l-3-1.732A.5.5 0 0 1 7.5 7V4a.5.5 0 0 1 .5-.5z" />
                      <path d="M8 16a8 8 0 1 0 0-16a8 8 0 0 0 0 16zm0-1a7 7 0 1 1 0-14a7 7 0 0 1 0 14z" />
                    </svg>
                  </div>
                  <div>
                    <h4 className="mb-3">Working Hours</h4>
                    <p className="mb-0 text-secondary">Monday - Friday: 9:00 AM - 6:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
